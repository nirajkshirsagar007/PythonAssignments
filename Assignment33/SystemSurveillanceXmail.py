...
def CreateLog(mailId,FolderName):
    Border = "-"*50
    Ret = False
    ...
    sender_email = "nirajpython.test@gmail.com"

    app_password = "fzpy deeo iulh ecgw"
    ...
    Total Process: {len(Data)}

    Top memory Consuming processes are attached in log file.
    ...
    for proc in psutil.process_iter():
        try:
            ...
            try:
                ...
                info["open_files"] = len(open_files)
...
def main():
    ...
    if(len(sys.argv) == 2):
        if(sys.argv[1] == "--h" or sys.argv[1] == "--H"):
            ...
            print("ScriptName.py <TimeInterval> <email> <DirectoryName>")
            print("TimeInterval : The time in minutes for periodic scheduling")
            print("Email: email id to send mail")
    ...
    # python Demo.py 5 Marvellous
        ...
        print("email id : ",sys.argv[2])
        print("Directory name : ",sys.argv[3])
        ...
        print("Directory created with name : ",sys.argv[3])
